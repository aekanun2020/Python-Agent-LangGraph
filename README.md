...
├── labs/                       # Lab 1–8 เรียงตาม course outline (ดู labs/README.md)
│   ├── core/                   # โค้ดกลางที่ทุก Lab ใช้ร่วมกัน (config/llm/mcp_client/registry)
│   ├── lab1_setup/ ... lab7_memory/   # Lab 1–7 (Pure Python Agent)
│   └── lab8_langgraph/
│       └── agent_langgraph.py  # Lab 8: LangGraph Agent + MCP client + OpenRouter (MSSQL จริง)
├── discover_mssql.py           # ยูทิลิตี้ตรวจการเชื่อมต่อ + list tools/args schema
├── screenshots/labs/           # ภาพหน้าจอผลการรันทดสอบจริง (Lab 1–8)
│   ├── lab1_check_env.png ... lab7_memory.png
│   ├── lab8_01_mssql_discovery.png
│   ├── lab8_02_agent_q1.png
│   └── lab8_03_agent_q2.png
├── requirements.txt
